...
- [ ] **Google Search Console** — verify `www.nerocasa.com`, submit sitemap, request indexing (home, coffee-tables, Soglia, Why)
...
- [ ] Search Console + Bing: verify domain, submit sitemap, inspect home + Soglia + The 9
