#!/usr/bin/env node
/**
 * Create/update Privacy Policy page in Shopify Admin.
 * Usage: node scripts/publish-privacy-page.mjs zhjbdz-yw.myshopify.com
 */
...
<p>NeroCasa operates this store and website, including all related information, content, features, tools, products and services, in order to provide you, the customer, with a curated shopping experience (the "Services"). NeroCasa is powered by Shopify, which enables us to provide the Services to you. This Privacy Policy describes how we collect, use, and disclose your personal information when you visit, use, or make a purchase or other transaction using the Services or otherwise communicate with us. If there is a conflict between our Terms of Service and this Privacy Policy, this Privacy Policy controls with respect to the collection, processing, and disclosure of your personal information.</p>
...
<p><strong>Marketing and Advertising.</strong> We use your personal information for marketing and promotional purposes, such as to send marketing, advertising and promotional communications by email, text message or postal mail, and to show you online advertisements for products or services on the Services or other websites, including based on items you previously have purchased or added to your cart and other activity on the Services.</p>
<p><strong>Security and Fraud Prevention.</strong> We use your personal information to authenticate your account, to provide a secure payment and shopping experience, detect, investigate or take action regarding possible fraudulent, illegal, unsafe, or malicious activity, protect public safety, and to secure our services. If you choose to use the Services and register an account, you are responsible for keeping your account credentials safe. We highly recommend that you do not share your username, password or other access details with anyone else.</p>
<p><strong>Communicating with You.</strong> We use your personal information to provide you with customer support, to be responsive to you, to provide effective services to you and to maintain our business relationship with you.</p>
<p><strong>Legal Reasons.</strong> We use your personal information to comply with applicable law or respond to valid legal process, including requests from law enforcement or government agencies, to investigate or participate in civil discovery, potential or actual litigation, or other adversarial legal proceedings, and to enforce or investigate potential violations of our terms or policies.</p>
...
function execute(query, variables, allowMutations = false) {
  const dir = mkdtempSync(join(tmpdir(), 'nc-privacy-'));
  ...
  try {
    return JSON.parse(
      execFileSync(shopifyCmd, args, {
        ...
        shell: isWin,
        env: { ...process.env, SHOPIFY_CLI_AGENT_INFO: 'n:cursor|v:1|p:cursor|m:privacy-page' },
      }),
    );
  } finally {
...
let privacy = pages.find((p) => p.handle === 'privacy');
...
if (!privacy) {
  ...
  privacy = created.pageCreate.page;
  console.log(`  + created ${privacy.handle}`);
} else {
  console.log('Updating privacy page...');
  ...
  if (errs.length) throw new Error(errs.map((e) => e.message).join('; '));
  privacy = updated.pageUpdate.page;
  console.log(`  + updated ${privacy.handle}`);
}
  ...
  }`,
  {
    metafields: [
      ...
      },
      {
        ...
        key: 'description_tag',
        type: 'single_line_text_field',
        value: 'NeroCasa Privacy Policy — how we collect, use and disclose personal information when you shop or contact us.',
      },
    ],
  },
  true,
...
console.log('\nDone. Official Privacy Policy is live at /pages/privacy');
